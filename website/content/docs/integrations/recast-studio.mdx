...
```bash
pnpm exec recast-studio https://myapp.example.com
```
...
```bash
pnpm exec recast-studio -o ./recordings/demo-1 https://myapp.example.com
```
...
```bash
pnpm exec recast-studio --load-storage auth.json https://myapp.example.com/dashboard
```
...
```bash
pnpm exec recast-studio --viewport 1280x720 https://myapp.example.com
```
