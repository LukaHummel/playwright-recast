...
# With speed processing
pnpm exec playwright-recast -i ./test-results/trace.zip -o demo.mp4 --speed-idle 4.0

# With subtitles
pnpm exec playwright-recast -i ./test-results/trace.zip -o demo.mp4 --srt narration.srt --burn-subs
```
